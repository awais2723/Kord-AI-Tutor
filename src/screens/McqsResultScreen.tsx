        ...
        {results.map((item, index) => (
          <View key={index} style={styles.resultItem}>
            ...
            <View style={[styles.answerRow, !item.isCorrect && styles.incorrectAnswerRow]}>
              <Ionicons name={item.isCorrect ? "checkmark-circle" : "close-circle"} size={20} color={item.isCorrect ? "#10B981" : "#EF4444"} />
...
const styles = StyleSheet.create({
  ...
  answerRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, paddingHorizontal: 12, borderRadius: 8 },
