...
class SettingsScreen extends Component<Props, State> {
  ...
  handleChangePassword = async () => {
    const { currentPassword, newPassword, confirmPassword, passwordLoading } = this.state;
    const { currentUser } = this.context;
  ...
  renderSettingItem = (
    ...
    const IconComponent =
      iconLib === 'Ionicons' ? Ionicons : iconLib === 'MaterialIcons' ? MaterialIcons : Feather;
    ...
    return (
      <TouchableOpacity
        ...
        <View className="flex-row items-center flex-1 mr-2">
          ...
          <Text
            className="text-gray-800 font-semibold text-lg ml-3"
            style={{ flexShrink: 1 }}
            numberOfLines={1}
            ellipsizeMode="tail">
            {title}
